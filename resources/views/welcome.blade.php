            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                @auth
                    <a href="{{ url('/admin/projects') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Projects
                        /
                    </a>
                    <a href="{{ url('/home') }}"
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="row">
                @forelse ($projects as $project)
                    <div class="card-div col-md-4 mb-4">
                        <div class="card">
                            <div class="card-body">
